    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          height5Space,
          vehicleDetailWidget(
              "Hãng xe", "Toyota Matrix | KJ 5454 | Màu đen"),
          heightSpace,
          heightSpace,
          vehicleDetailWidget("Thiết bị:", "AC , Ghế massage, Hệ thống nghe nhạc")
        ],
      ),
    );
  }
      ...
      child: Column(
        children: [
              ...
              children: [
                ...
                Column(
                  ...
                  children: [
                    address(
                      greenColor,
                      '132 Xuân Thủy, Dịch Vọng Hậu, Cầu Giấy, Hà Nội',
                    ),
                    Padding(
                      padding:
                    ...
                    address(
                      redColor,
                      'Lê Đức Thọ,Từ Liêm, Hà Nội, Việt Nam',
                    ),
                  ],
                ),
              ],
          ...
          Padding(
            ...
            child: Row(
              children: [
                detailWidget("Bắt đầu vào", "19/12/2023", 3),
                verticaldivider(),
                detailWidget("Kết thúc", "19/05/2024", 3),
                verticaldivider(),
                detailWidget("Đã đi với", "150 Người", 2),
              ],
            ),
          ),
        ],
