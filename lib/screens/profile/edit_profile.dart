...
class _EditProfileScreenState extends State<EditProfileScreen> {
  ...
  @override
  void initState() {
    userNameController.text = "Tạ Thành Bảo";
    emailController.text = "baobk@mail.com";
    mobileNumberController.text = "+84 0832713221";
    super.initState();
  }
      ...
      builder: (context) {
        return ListView(
          ...
          children: [
            ...
            heightSpace,
            imageChangeOption(
                CupertinoIcons.trash_fill, darkRedColor, "Xóa ảnh"),
          ],
        );
      },
    );
