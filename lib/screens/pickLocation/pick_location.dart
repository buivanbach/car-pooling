...
class _PickLocationScreenState extends State<PickLocationScreen> {
  ...
  static CameraPosition locationposition =
      const CameraPosition(target: LatLng(21.037102689334308, 105.78234919888015), zoom: 15.46);
  ...
  void defaultAddress() async {
    List<Placemark> defaultPlace =
        await placemarkFromCoordinates(21.037004652071836, 105.78229263984008);
  ...
  googleMap() {
    return GoogleMap(
      ...
      onTap: (LatLng latLng) async {
        const MarkerId markerId = MarkerId('Vị trí của bạn');
      ...
      onMapCreated: (GoogleMapController controller) {
        ...
        addMarker(
          /// todo Viet hoa lai
          'Vị trí của bạn',
          const LatLng(21.037004652071836, 105.78229263984008),
        );
      },
